...
function onHandleMouseDown(e) {
	...
	outlineEditorElement._maintainOutlineEditorSelection = editor.selection;
	e.stopPropagation();
}
...
function onHandleFocusOut(e) {
	var outlineEditorElement = getOutlineEditorElement(e),
		maintainOutlineEditorSelection = outlineEditorElement._maintainOutlineEditorSelection,
		editor = outlineEditorElement.editor;

	if (maintainOutlineEditorSelection) {
		setTimeout(function() {
			if (maintainOutlineEditorSelection.isTextMode) {
				editor.focus();
				editor._disableScrollToSelection = true;
				editor.moveSelectionRange(maintainOutlineEditorSelection);
